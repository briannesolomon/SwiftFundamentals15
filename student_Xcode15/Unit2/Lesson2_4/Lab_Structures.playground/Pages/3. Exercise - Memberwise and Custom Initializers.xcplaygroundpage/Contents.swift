...
let favoriteBook = Book(title: "Days Gone Bye", author: "Robert Kirkman", pages: 22, price: 14.99)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). \(favoriteBook.title) has \(favoriteBook.pages)")
...
let screenRepair = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2022)
print("The laptop is \(screenRepair.screenSize) inches wide, has been fixed \(screenRepair.repairCount) times, and was purchased in \(screenRepair.yearPurchased).")
