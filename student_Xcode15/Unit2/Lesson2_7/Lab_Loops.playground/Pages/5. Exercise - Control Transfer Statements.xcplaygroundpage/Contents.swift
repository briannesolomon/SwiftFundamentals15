...
var homeState = "North Carolina"
let dictionary: [String: String] = ["North Carolina": "Raleigh", "Virginia": "Richmond", "South Carolina": "Columbia"]
for (state, capitol) in dictionary {
