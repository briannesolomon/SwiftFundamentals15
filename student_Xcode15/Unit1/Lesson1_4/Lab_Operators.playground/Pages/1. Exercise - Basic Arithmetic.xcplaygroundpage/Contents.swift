...
let even = 6
let evenRemainder = 6 % 2
print(evenRemainder)
let odd = 3
let oddRemainder = 3 % 2
print(oddRemainder)
print("You could use the remainder operator to check if an integer is even or odd based on your remainder. If you devide by an even number an even number should have no remainder. An odd number willlet pi = 3.1415927 
/*:
