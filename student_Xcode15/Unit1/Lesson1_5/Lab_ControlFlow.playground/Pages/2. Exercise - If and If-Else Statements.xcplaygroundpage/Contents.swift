 ...
 */
var dollars = 0
if dollars == 0 { print("Sorry, kid. Your'e broke!") }
...
dollars = 10
if dollars == 0 { print("Sorry, kid. Your'e broke!")}
else { print("Youv'e got some spending money!")}
...
dollars = 105
if dollars == 0 { print("Sorry, kid. Your'e broke!")}
if dollars < 100 { print("You've got some spending money!")}
 else { print("Looks to me like your'e rich!")}
